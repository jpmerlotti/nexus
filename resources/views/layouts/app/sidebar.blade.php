...
<body
    ...
    <flux:sidebar sticky collapsible="mobile"
        class="border-e border-stone-200 dark:border-stone-800 bg-zinc-50/50 dark:bg-stone-900/30 backdrop-blur-md">
        <flux:sidebar.header>
        ...
        <flux:sidebar.nav>
            <flux:sidebar.item icon="folder-git-2" href="https://joaopedromerlotti.com.br/nexus-ai" target="_blank">
                {{ __('Blog') }}
            </flux:sidebar.item>

            <flux:sidebar.item icon="book-open-text" href="{{ route('docs') }}" target="_blank">
                {{ __('Documentation') }}
            </flux:sidebar.item>
        </flux:sidebar.nav>
    ...
    <!-- Mobile User Menu -->
    <flux:header
        class="lg:hidden bg-zinc-50/50 dark:bg-stone-900/50 backdrop-blur-md border-b border-stone-200 dark:border-stone-800">
